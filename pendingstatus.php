...
$sql1 = "UPDATE tb_complaint SET comp_status='1' WHERE comp_id = '$compid'";
$result1 = mysqli_query($conn, $sql1);

if($result1)
{
    echo "<script> alert('Status changed to pending! ');window.location.href = 'homepageofficer.php'</script>";
}
else
{
